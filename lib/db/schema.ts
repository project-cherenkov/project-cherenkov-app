...
export const account = pgTable(
  ...
  {
    id: text("id").primaryKey(),
    // Better Auth's default account schema requires an issuer namespace so
    // Google / credential / other providers can be distinguished when multiple
    // providers or linked identities share the same accountId.
